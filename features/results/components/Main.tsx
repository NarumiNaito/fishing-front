export default function Main() {
  return (
    <>
      <section className="bg-cyan-100 p-8 md:py-12 lg:py-24 ">
        <div className="space-y-5 px-5 md:px-10 lg:px-20 xl:36">
          <h2 className="font-extrabold text-3xl md:text-5xl ">釣果速報</h2>
