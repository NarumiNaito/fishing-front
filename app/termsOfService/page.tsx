...
const TermsOfService: React.FC = () => {
  return (
    <div className="md:w-10/12 mt-10 mb-10 pb-6  mx-auto md:h-auto text-gray-800 rounded bg-white">
      <div className="px-10">
        <h2 className="font-bold text-2xl text-center py-10">利用規約</h2>
        <p>
          この利用規約（以下，「本規約」といいます。）は、Anglers
          App（以下，「当方」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第3条（ユーザーIDおよびパスワードの管理）</h3>
        <ul className="list-decimal ml-4">
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第5条（本サービスの提供の停止等）</h3>
        <ul className="list-decimal ml-4">
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第6条（利用制限および登録抹消）</h3>
        <ul className="list-decimal ml-4">
          <li>
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第7条（保証の否認および免責事項）</h3>
        <ul className="list-decimal ml-4">
          <li>
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第8条（サービス内容の変更等）</h3>
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第10条（個人情報の取扱い）</h3>
        <p>当方は，本サービスの利用によって取得する個人情報については，当方「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
        <h3 className="font-bold text-xl pt-5 pb-1">第11条（権利義務の譲渡の禁止）</h3>
        <p>ユーザーは，当方の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>
        <h3 className="font-bold text-xl pt-5 pb-1">第12条（準拠法・裁判管轄）</h3>
        <ul className="list-decimal ml-4">
