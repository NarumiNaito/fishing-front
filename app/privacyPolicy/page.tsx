...
const PrivacyPolicy: React.VFC = () => {
  return (
    <div className="w-11/12 mt-10 mb-10 pb-6 md:w-8/12 mx-auto md:h-auto text-gray-800 rounded bg-white">
      <div className="px-10">
        <h2 className="font-bold text-2xl text-center py-10">プライバシーポリシー</h2>
        <p>
          Anglers
          Map（以下，「当方」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
        </p>
        <h3 className="font-bold text-xl pt-5 pb-1">第1条（個人情報）</h3>
        <p>
          「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
        </p>
        <h3 className="font-bold text-xl pt-5 pb-1">第2条（個人情報の収集方法）</h3>
        <p>
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第3条（個人情報を収集・利用する目的）</h3>
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第5条（個人情報の第三者提供）</h3>
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第7条（個人情報の訂正および削除）</h3>
        <ol className="list-decimal ml-4">
          <li>
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第8条（個人情報の利用停止等）</h3>
        <ol className="list-decimal ml-4">
          <li>
        ...
        <h3 className="font-bold text-xl pt-5 pb-1">第9条（プライバシーポリシーの変更）</h3>
        <ol className="list-decimal ml-4">
          <li>本ポリシーの内容は，法令その他本ポリシーに別段の定めのある事項を除いて，ユーザーに通知することなく，変更することができるものとします。</li>
          <li>当方が別途定める場合を除いて，変更後のプライバシーポリシーは，本ウェブサイトに掲載したときから効力を生じるものとします。</li>
        </ol>
        <h3 className="font-bold text-xl pt-5 pb-1">第10条（お問い合わせ窓口）</h3>
        <p>本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。</p>
        <div className="break-all">
          Eメールアドレス：
          <Link href={"/contact"} className="px-0 text-blue-500 underline decoration-blue-500 hover:text-blue-400 transition-all">
            @gmail.com
          </Link>
        </div>
      </div>
